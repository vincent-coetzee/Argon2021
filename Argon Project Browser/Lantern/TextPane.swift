...
public class TextPane:Pane
    {
    internal let actualText = CATextLayer()
    ...
    internal func measureText() -> CGSize
        {
...
public class PaneNakedText:TextPane
    {
    ...
    public override func layout()
        {
        self.actualText.frame = NSRect(origin:.zero,size:self.textSize)
        }
    }
